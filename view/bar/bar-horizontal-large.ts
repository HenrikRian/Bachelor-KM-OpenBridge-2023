...
export class BarHorizontalLarge extends ObElement {
  ...
  protected render(): unknown {
    ...
    <svg viewBox="-256 -72 512 144">
        ...
        <text x="-208" y="44" class="ob-font-ui-body-active ob-center-label">${-this
          .range}</text>
        <text x="208" y="44" class="ob-font-ui-body-active ob-center-label">${
          this.range
        }</text>
        <text x="0" y="44" class="ob-font-ui-body-active ob-center-label">0</text>
        <text x="-104" y="44" class="ob-font-ui-body ob-center-label">${
          -this.range / 2
        }</text>
        <text x="104" y="44" class="ob-font-ui-body ob-center-label">${
          this.range / 2
