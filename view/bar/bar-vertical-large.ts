...
export class BarVerticalLarge extends ObElement {
  ...
  protected render(): unknown {
    ...
    <svg viewBox="-72 -256 144 512">
        ...
        <text x="-40" y="-221" class="ob-font-ui-body-active ob-right-label">${
          this.range
        }</text>
        <text x="-40" y="221" class="ob-font-ui-body-active ob-right-label">${-this
          .range}</text>
        <text x="-40" y="0" class="ob-font-ui-body-active ob-right-label">0</text>
        <text x="-40" y="110" class="ob-font-ui-body ob-right-label">${
          -this.range / 2
        }</text>
        <text x="-40" y="-110" class="ob-font-ui-body ob-right-label">${
          this.range / 2
