...
export function primaryTickmarksSmall(showDeg: number, startClipDeg: number, endClipDeg: number, showArrow: boolean) {
    function show(deg: number): boolean {
        return !(endClipDeg > deg + 360 || (startClipDeg < deg && endClipDeg > deg));
    }
        ...
        svg`<g id="30Â°" v-if="showDeg===30">
          <g id="60Â°">
            <g id="Thick 08px" clip-path="url(#Small/ Angle Masterclip0)">
              ${show(300) ? svg`<path id="Vector 3" d="M17.637 29.4133L24.6028 33.435" stroke="#999999"
                    class="ob-instrument-tick-mark-secondary-color-stroke"/>` : null}
              ${show(120) ? svg`<path id="Vector 4" d="M66.3972 57.565L73.3629 61.5867" stroke="#999999"
                    class="ob-instrument-tick-mark-secondary-color-stroke"/>` : null}
              ${show(210) ? svg`<path id="Vector 5" d="M29.4133 73.3629L33.4349 66.3972" stroke="#999999"
                    class="ob-instrument-tick-mark-secondary-color-stroke"/>` : null}
              ${show(30) ? svg`<path id="Vector 6" d="M57.5649 24.6028L61.5866 17.637" stroke="#999999"
                    class="ob-instrument-tick-mark-secondary-color-stroke"/>` : null}
            </g>
          </g>
          <g id="30Â°_2">
