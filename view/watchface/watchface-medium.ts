...
import InnerCircleRegularMedium from "../../generated-without-style/WatchFace/InnerCircleRegularMedium.svg";
import InnerCirclePortStarboardMedium from "../../generated-without-style/WatchFace/InnerCirclePortStarboardMedium.svg";
import InnerCirclePositiveNegativeMedium from "../../generated-without-style/WatchFace/InnerCirclePositiveNegativeMedium.svg";
import CrossRegularMedium from "../../generated-without-style/WatchFace/CrossRegularMedium.svg";
...
export function watchFaceMediumRender(option: {
  ...
  primaryTickMarks: number;
  secondaryTickMarks: number | null;
  rotate: number;
  startClipDeg: number;
  endClipDeg: number;
  showLabels: boolean;
    ...
    <g transform="rotate(${option.rotate})">
      <g mask="url(#clipPathWatchFaceMedium${option.uuid})">
        ...
        <svg width="363" height="363" x="-181.5" y="-181.5">
            ${primaryTickmarksMedium(
              option.primaryTickMarks,
              option.showLabels,
              option.rotate
            )}
        </svg>
