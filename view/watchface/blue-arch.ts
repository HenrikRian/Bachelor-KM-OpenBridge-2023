...
export function renderBlueArch(radius: number, startDeg: number, endDeg: number, strokeWidth: number) {
    const r = radius;
    ...
    stroke-width="${strokeWidth || 2}" fill="none" class="ob-instrument-dynamic-color-stroke"/>`;
}
